<template>
	<button class="rounded-full h-14 w-14 bg-red-500 flex items-center justify-center" @click="handleTime">
		<Icon :icon="active ? 'bi:pause-fill' : 'bi:play-fill'" width="48" height="48" class="text-white" />
	</button>
</template>
